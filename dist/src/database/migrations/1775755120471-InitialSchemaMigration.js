...
exports.InitialSchemaMigration1775755120471 = void 0;
class InitialSchemaMigration1775755120471 {
    ...
    async down(queryRunner) {
        await queryRunner.query(`
            ...
            DROP TABLE "user_quotes";
            DROP TABLE "service_packages";
            DROP TABLE "points_config";
            DROP TABLE "notification_preferences";
            DROP TABLE "invitation_feed";
            DROP TABLE "consultation_bookings";
            DROP TABLE "consultation_questionnaire";
            DROP TABLE "state_nominations";
            DROP TABLE "invitation_trends";
            DROP TABLE "activity_log";
            DROP TABLE "occupation_thresholds";
            DROP TABLE "occupations_list";
            DROP TABLE "profiles";
            DROP TABLE "users";

            DROP TYPE "users_role_enum";
            DROP TYPE "state_nominations_state_code_enum";
            DROP TYPE "state_nominations_priority_level_enum";
            DROP TYPE "consultation_bookings_status_enum";
            DROP TYPE "service_packages_category_enum";
            DROP TYPE "user_quotes_status_enum";
        `);
    }
}
exports.InitialSchemaMigration1775755120471 = InitialSchemaMigration1775755120471;
//# sourceMappingURL=1775755120471-InitialSchemaMigration.js.map