...
exports.CreateVisasAndOccupationVisas1788000000000 = void 0;
class CreateVisasAndOccupationVisas1788000000000 {
    ...
    `);
        await queryRunner.query(`DROP TYPE IF EXISTS "occupations_list_primary_list_enum";`);
        await queryRunner.query(`
      ALTER TABLE "occupation_thresholds"
        DROP CONSTRAINT IF EXISTS "FK_thresholds_occupations";
    `);
...
exports.CreateVisasAndOccupationVisas1788000000000 = CreateVisasAndOccupationVisas1788000000000;
//# sourceMappingURL=1788000000000-CreateVisasAndOccupationVisas.js.map