...
const points_aggregator_service_1 = require("./points-aggregator.service");
...
let PointsEngineController = class PointsEngineController {
    ...
    pointsRuleService;
    userPointsService;
    constructor(pointsEngineService, calculator, aggregator, pointsRuleService, userPointsService) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Calculate GSM points (legacy, public, stateless)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        summary: 'Aggregate structured points from a user profile (AGE, ENGLISH, work, QUALIFICATIONS, REGIONAL_STUDY) with the 20-point combined-work cap',
    }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_profile_dto_1.UserProfileDto]),
    __metadata("design:returntype", void 0)
], PointsEngineController.prototype, "calculateTotal", null);
__decorate([
...
exports.PointsEngineController = PointsEngineController = __decorate([
    ...
    __metadata("design:paramtypes", [points_engine_service_1.PointsEngineService,
        ...
        points_aggregator_service_1.PointsAggregatorService,
