...
export declare class PointsEngineController {
    ...
    constructor(pointsEngineService: PointsEngineService, calculator: PointsCalculatorService, aggregator: PointsAggregatorService, pointsRuleService: PointsRuleService, userPointsService: UserPointsService);
    calculate(input: PointsInputDto): Promise<import("./dto/points.dto").PointsResultDto>;
    calculateTotal(profile: UserProfileDto): Promise<import("./dto/user-profile.dto").StructuredPointsResultDto>;
