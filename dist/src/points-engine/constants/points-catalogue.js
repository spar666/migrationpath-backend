...
exports.STRUCTURED_POINTS_RULES = [
    ...
    {
        visaGroup: 'GSM',
        category: PointsCategory.ENGLISH,
        attributeLabel: EnglishProficiency.SUPERIOR,
        minValue: null,
        maxValue: null,
        points: 20,
    },
    {
        visaGroup: 'GSM',
        category: PointsCategory.ENGLISH,
        attributeLabel: EnglishProficiency.PROFICIENT,
        minValue: null,
        maxValue: null,
        points: 10,
    },
    {
        visaGroup: 'GSM',
        category: PointsCategory.ENGLISH,
        attributeLabel: EnglishProficiency.COMPETENT,
        minValue: null,
        maxValue: null,
        points: 0,
    },
    {
        visaGroup: 'GSM',
        category: PointsCategory.OVERSEAS_WORK,
        attributeLabel: null,
        minValue: 0,
        maxValue: 2,
        points: 0,
    ...
    {
        visaGroup: 'GSM',
        category: PointsCategory.AUSTRALIAN_WORK,
        attributeLabel: null,
        minValue: 0,
        maxValue: 0,
        points: 0,
    ...
    {
        visaGroup: 'GSM',
        category: PointsCategory.QUALIFICATIONS,
        attributeLabel: QualificationLevel.DOCTORATE,
        minValue: null,
        maxValue: null,
        points: 20,
    },
    {
        visaGroup: 'GSM',
        category: PointsCategory.QUALIFICATIONS,
        attributeLabel: QualificationLevel.BACHELOR_MASTERS,
        minValue: null,
        maxValue: null,
        points: 15,
    },
    {
        visaGroup: 'GSM',
        category: PointsCategory.QUALIFICATIONS,
        attributeLabel: QualificationLevel.DIPLOMA_TRADE,
        minValue: null,
        maxValue: null,
        points: 10,
    },
    {
        visaGroup: 'GSM',
        category: PointsCategory.QUALIFICATIONS,
        attributeLabel: QualificationLevel.OTHER_RECOGNISED,
        minValue: null,
        maxValue: null,
        points: 10,
    },
    {
        visaGroup: 'GSM',
        category: PointsCategory.REGIONAL_STUDY,
        attributeLabel: 'regional',
        minValue: null,
        maxValue: null,
        points: exports.REGIONAL_STUDY_POINTS,
    },
];
