...
let PaymentsController = class PaymentsController {
    ...
    constructor(paymentsService, reconciliationService) {
        this.paymentsService = paymentsService;
        this.reconciliationService = reconciliationService;
    }
    createConsultationCheckout(dto) {
...
__decorate([
    (0, common_1.Post)('consultation/checkout'),
    ...
    __metadata("design:paramtypes", [create_checkout_dto_1.CreateConsultationCheckoutDto]),
    __metadata("design:returntype", void 0)
], PaymentsController.prototype, "createConsultationCheckout", null);
__decorate([
    (0, common_1.Get)('prospect/:prospectId'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
    (0, swagger_1.ApiOperation)({ summary: 'List payments for a prospect (admin only)' }),
    __param(0, (0, common_1.Param)('prospectId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PaymentsController.prototype, "findForProspect", null);
__decorate([
...
exports.PaymentsController = PaymentsController = __decorate([
    ...
    __metadata("design:paramtypes", [payments_service_1.PaymentsService,
        payment_reconciliation_service_1.PaymentReconciliationService])
], PaymentsController);
