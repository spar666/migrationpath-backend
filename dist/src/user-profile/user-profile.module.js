...
exports.UserProfileModule = UserProfileModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([profile_entity_1.Profile, user_entity_1.User]), notifications_module_1.NotificationsModule],
        controllers: [user_profile_controller_1.UserProfileController],
        providers: [user_profile_service_1.UserProfileService, profile_repository_1.ProfileRepository],
        exports: [user_profile_service_1.UserProfileService, profile_repository_1.ProfileRepository],
    })
], UserProfileModule);
