...
export declare class ProspectSummaryService {
    ...
    constructor(summaryRepository: ProspectSummaryRepository, prospectRepository: ProspectRepository, sponsorRepository: SponsorRepository, nominationRepository: NominationRepository, bookingRepository: ConsultationBookingRepository, payments: Repository<Payment>);
