...
exports.ConsultationBooking = exports.ConsultationQuestionnaire = void 0;
const typeorm_1 = require("typeorm");
const user_entity_1 = require("../../auth/entities/user.entity");
let ConsultationQuestionnaire = class ConsultationQuestionnaire {
    id;
    user_id;
    responses;
    created_at;
...
exports.ConsultationQuestionnaire = ConsultationQuestionnaire;
__decorate([
    (0, typeorm_1.PrimaryGeneratedColumn)('uuid'),
    __metadata("design:type", String)
], ConsultationQuestionnaire.prototype, "id", void 0);
__decorate([
    (0, typeorm_1.Column)('uuid'),
    __metadata("design:type", String)
], ConsultationQuestionnaire.prototype, "user_id", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'jsonb' }),
    __metadata("design:type", Object)
], ConsultationQuestionnaire.prototype, "responses", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)(),
    __metadata("design:type", Date)
], ConsultationQuestionnaire.prototype, "created_at", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)(),
    __metadata("design:type", Date)
], ConsultationQuestionnaire.prototype, "updated_at", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'user_id' }),
    __metadata("design:type", user_entity_1.User)
], ConsultationQuestionnaire.prototype, "user", void 0);
exports.ConsultationQuestionnaire = ConsultationQuestionnaire = __decorate([
    (0, typeorm_1.Entity)('consultation_questionnaire')
...
__decorate([
    ...
    (0, typeorm_1.Column)({ type: 'varchar', nullable: true }),
    __metadata("design:type", Object)
], ConsultationBooking.prototype, "invitee_email", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', nullable: true }),
    __metadata("design:type", Object)
], ConsultationBooking.prototype, "invitee_name", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.Column)({ type: 'timestamptz', nullable: true }),
    __metadata("design:type", Object)
], ConsultationBooking.prototype, "client_reported_at", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'text', nullable: true }),
    __metadata("design:type", String)
], ConsultationBooking.prototype, "strategy_delivery", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)(),
    __metadata("design:type", Date)
], ConsultationBooking.prototype, "created_at", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)(),
    __metadata("design:type", Date)
...
exports.ConsultationBooking = ConsultationBooking = __decorate([
    (0, typeorm_1.Entity)('consultation_bookings')
], ConsultationBooking);
