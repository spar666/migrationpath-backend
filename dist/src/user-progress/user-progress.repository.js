...
let UserProgressRepository = class UserProgressRepository extends base_repository_1.BaseRepository {
    repo;
    constructor(repo) {
        super(repo);
        this.repo = repo;
    ...
    async findOneByUserAndId(userId, id) {
...
exports.UserProgressRepository = UserProgressRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(user_progress_entity_1.UserProgress)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], UserProgressRepository);
//# sourceMappingURL=user-progress.repository.js.map