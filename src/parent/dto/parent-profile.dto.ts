...
export class ParentProfileDto {
  ...
  @ApiProperty({
    description:
      'Months the sponsoring child has lawfully resided in Australia',
    example: 30,
  })
  @IsInt()
  @Min(0)
  ...
  @ApiProperty({
    description: 'Total number of children the parent has, globally',
  })
  @IsInt()
  @Min(0)
  @Max(50)
  ...
  @ApiProperty({
    description:
      'Children who are permanent residents/citizens living in Australia',
  })
  @IsInt()
  @Min(0)
  @Max(50)
  ...
  @ApiProperty({
    description: "Sponsor's current taxable income (AUD)",
    example: 72000,
  })
  @IsInt()
  @Min(0)
  ...
  // ---- Visa path ----
  @ApiProperty({
    description: 'Age of the applying parent (years)',
    example: 68,
  })
  @IsInt()
  @Min(0)
