  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_regional_band_category" ON "regional_postcode_bands" ("category");`,
    );
    ...
    for (const [region, category, from, to] of rows) {
      await queryRunner.query(
        `INSERT INTO "regional_postcode_bands" ("region","category","postcode_from","postcode_to")
         VALUES ($1,$2,$3,$4);`,
